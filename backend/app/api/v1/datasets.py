...
async def upload_dataset(
    ...
    try:
        ...
        return SuccessResponse(data={"dataset_id": dataset.id}, message="Dataset registered successfully")
...
async def list_datasets(
    ...
    return SuccessResponse(data={"datasets": [d.id for d in datasets]}, message="Datasets retrieved")
...
async def ask_question(
    ...
    try:
        ...
        return SuccessResponse(
            data={"answer": query_result.answer, "chart_config": query_result.chart_config}, 
