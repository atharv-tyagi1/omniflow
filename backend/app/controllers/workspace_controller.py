...
from backend.app.schemas.workspace import WorkspaceResponse, WorkspaceUpdateRequest, WorkspaceStatsResponse
...
class WorkspaceController:
    ...
    @staticmethod
    async def update_workspace(db: AsyncSession, workspace_id: UUID, update_data: WorkspaceUpdateRequest) -> dict:
        workspace = await WorkspaceService.update_workspace(db, workspace_id, update_data)
        workspace_resp = WorkspaceResponse.model_validate(workspace)
        return success_response(workspace_resp.model_dump())
